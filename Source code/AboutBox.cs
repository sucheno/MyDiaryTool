namespace My_Dairy
{
    ...
    internal class AboutBox : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tableLayoutPanel.Location = new Point(10, 9);
            ...
            this.tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 10f));
            this.tableLayoutPanel.Size = new Size(0x193, 0x108);
            ...
            this.logoPictureBox.Size = new Size(0x7e, 0x102);
            this.logoPictureBox.SizeMode = PictureBoxSizeMode.StretchImage;
            this.logoPictureBox.TabIndex = 12;
            this.logoPictureBox.TabStop = false;
            this.labelProductName.Dock = DockStyle.Fill;
            this.labelProductName.Location = new Point(0x8b, 0);
            this.labelProductName.Margin = new Padding(7, 0, 3, 0);
            this.labelProductName.MaximumSize = new Size(0, 0x11);
            this.labelProductName.Name = "labelProductName";
            this.labelProductName.Size = new Size(0x105, 0x11);
            this.labelProductName.TabIndex = 0x13;
            this.labelProductName.Text = "Product Name";
            this.labelProductName.TextAlign = ContentAlignment.MiddleLeft;
            this.labelProductName.Click += new EventHandler(this.labelProductName_Click);
            this.labelVersion.Dock = DockStyle.Fill;
            this.labelVersion.Location = new Point(0x8b, 0x1a);
            this.labelVersion.Margin = new Padding(7, 0, 3, 0);
            this.labelVersion.MaximumSize = new Size(0, 0x11);
            this.labelVersion.Name = "labelVersion";
            this.labelVersion.Size = new Size(0x105, 0x11);
            this.labelVersion.TabIndex = 0;
            this.labelVersion.Text = "Version";
            this.labelVersion.TextAlign = ContentAlignment.MiddleLeft;
            this.labelCopyright.Dock = DockStyle.Fill;
            this.labelCopyright.Font = new Font("Verdana", 8.25f, FontStyle.Italic, GraphicsUnit.Point, 0);
            this.labelCopyright.Location = new Point(0x8b, 0x34);
            this.labelCopyright.Margin = new Padding(7, 0, 3, 0);
            this.labelCopyright.MaximumSize = new Size(0, 0x11);
            this.labelCopyright.Name = "labelCopyright";
            this.labelCopyright.Size = new Size(0x105, 0x11);
            ...
            this.labelCompanyName.Location = new Point(0x8b, 0x4e);
            this.labelCompanyName.Margin = new Padding(7, 0, 3, 0);
            this.labelCompanyName.MaximumSize = new Size(0, 0x11);
            this.labelCompanyName.Name = "labelCompanyName";
            this.labelCompanyName.Size = new Size(0x105, 0x11);
            ...
            this.textBoxDescription.Location = new Point(0x8b, 0x6b);
            this.textBoxDescription.Margin = new Padding(7, 3, 3, 3);
            this.textBoxDescription.Multiline = true;
            this.textBoxDescription.Name = "textBoxDescription";
            this.textBoxDescription.ReadOnly = true;
            this.textBoxDescription.ScrollBars = ScrollBars.Both;
            this.textBoxDescription.Size = new Size(0x105, 0x7e);
            this.textBoxDescription.TabIndex = 0x17;
            this.textBoxDescription.TabStop = false;
            this.textBoxDescription.Text = "Description";
            this.okButton.Anchor = AnchorStyles.Right | AnchorStyles.Bottom;
            this.okButton.DialogResult = DialogResult.Cancel;
            this.okButton.Location = new Point(0x139, 0xef);
            this.okButton.Name = "okButton";
            this.okButton.Size = new Size(0x57, 0x16);
            ...
            base.ClientSize = new Size(0x1a7, 0x11a);
            base.Controls.Add(this.tableLayoutPanel);
            this.Font = new Font("Verdana", 8.25f, FontStyle.Italic, GraphicsUnit.Point, 0);
